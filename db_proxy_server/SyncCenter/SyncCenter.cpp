...
// 从部门信息map里获取指定nDeptId部门信息，结果保存到pDept
 ...
 *  @param nUpdated 时间
 */
// 设置redis unread total_user_update为nUpdated
 ...
 *  @param nUpdated 时间
 */
// 更新redis unread last_update_group上次同步时间为nUpdated
...
//    } while (!m_pInstance->m_pCondGroupChat->waitTime(5*1000));
